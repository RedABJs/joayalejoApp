    ...
    <HomeLayout>
      <div className="h-full max-w-screen w-full flex justify-end items-center relative overflow-hidden">
        ...
        >
          ...
          <input
            className={`${!validated.user_name && "border-redwine"} formInputs`}
            type="text"
            name="user_name"
          ...
          >
            - El nombre no debe tener espacios al principio ni al final.
          </i>
          <label className="text-lg font-medium">
          ...
          >
            - El e-mail no debe tener espacios al principio ni al final.
          </i>
          <label className="text-lg font-medium">
            Mensaje <span className="text-redwine">*</span>
          </label>
          <textarea
            className={`${!validated.message && "border-redwine"} formInputs`}
            name="message"
            onChange={handleChange}
